...
@echo off
@title =  List of Files Generator (c) Guilherme Trevisan 2017.%Version%
color 1D
@echo on
@echo.
@echo.                _
@echo.               ( )                 List of Files Generator %Version%
@echo.                H                  Default format set to: %DefaultFormat%
...
@echo.
@echo.
@echo. 1 = Generate a list at script's location
@echo. 2 = Generate a list at a Custom Path
@echo. 3 = Change Format
@echo. 4 = Exit File
@echo. 
@echo. 
@echo off
...
@echo off
for %%* in (.) do set CurrDirName=%%~nx*
for /f "delims=" %%a in ('dir /b /on *%DefaultFormat%') do @echo %%~na >> "List of Files in %CurrDirName%.txt"
...
@echo.                _
@echo.               ( )
@echo.                H                  List of Files Generator %Version%
@echo.                H                  Format Changed to: %DefaultFormat%
@echo.               _H_ 
@echo.            .-'-.-'-.
@echo.           /         \             IMPORTANT: This script does NOT work with network paths.
@echo.          !           !            if you want to use it in a network,
